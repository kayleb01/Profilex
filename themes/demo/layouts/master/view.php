...
<html lang="en">
    <head>
        ...
        <!-- Load Require CSS -->
        <link href="<?=phpb_theme_asset('assets/css/bootstrap.min.css')?>" rel="stylesheet">
        <!-- Font CSS -->
        <link href="<?=phpb_theme_asset('assets/css/boxicon.min.css') ?>" rel="stylesheet">
        <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;600&display=swap" rel="stylesheet">
        <!-- Load Tempalte CSS -->
        <link rel="stylesheet" href="<?=phpb_theme_asset('assets/css/templatemo.css') ?>">
        <!-- Custom CSS -->
        <link rel="stylesheet" href="<?=phpb_theme_asset('assets/css/custom.css') ?>">
    </head>
<body>
...
<div class="banner-wrapper bg-light">
        ...
        <div class="row gx-5 gx-sm-3 gx-lg-5 gy-lg-5 gy-3 pb-3 projects">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project ui branding">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="service card-img" src="<?=phpb_theme_asset('/assets/img/services-01.jpg')?>" alt="Card image">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project ui graphic">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-02.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project branding">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-03.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project ui graphic">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-04.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project ui graphic">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-05.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project branding">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-06.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project branding">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-07.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 project ui graphic branding">
                <a href="#" class="service-work card border-0 text-white shadow-sm overflow-hidden mx-5 m-sm-0">
                    <img class="card-img" src="<?=phpb_theme_asset('/assets/img/services-08.jpg')?>" alt="Card image">
                    <div class="service-work-vertical card-img-overlay d-flex align-items-end">
                        <div class="service-work-content text-left text-light">
            ...
            <div class="row gy-5 g-lg-5 mb-4">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="<?=phpb_theme_asset('/assets/img/recent-work-01.jpg')?>" alt="Card image">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="<?=phpb_theme_asset('/assets/img/recent-work-02.jpg')?>" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="<?=phpb_theme_asset('/assets/img/recent-work-03.jpg')?>" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="<?=phpb_theme_asset('/assets/img/recent-work-04.jpg') ?>" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                ...
                <div class="col-md-4 mb-3">
                    <a href="#" class="recent-work card border-0 shadow-lg overflow-hidden">
                        <img class="recent-work-img card-img" src="<?=phpb_theme_asset('/assets/img/recent-work-05.jpg') ?>" alt="Card image">
                        <div class="recent-work-vertical card-img-overlay d-flex align-items-end">
                            <div class="recent-work-content text-start mb-3 ml-3 text-dark">
                ...
                <div class="row pt-2">
                    <div class="col-lg-6 col-sm-12">
                        <p class="text-lg-start text-center text-light light-300">
                            © Copyright 2022 SiteWings. All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <!-- Bootstrap -->
    <script src="<?=phpb_theme_asset('assets/js/bootstrap.bundle.min.js') ?>"></script>
    <!-- Load jQuery require for isotope -->
    <script src="<?=phpb_theme_asset('assets/js/jquery.min.js') ?>"></script>
    <!-- Isotope -->
    <script src="<?=phpb_theme_asset('assets/js/isotope.pkgd.js')?>"></script>
    <!-- Page Script -->
    <script>
    ...
    <!-- Templatemo -->
    <script src="<?=phpb_theme_asset('assets/js/templatemo.js')?>"></script>
    <!-- Custom -->
    <script src="<?=phpb_theme_asset('assets/js/custom.js') ?>"></script>
<!-- Optional JavaScript -->
